...
public abstract class ModProcessors {
    ...
    public static final DeferredRegister<StructureProcessorType<?>> STRUCTURE_PROCESSOR = DeferredRegister.create(Registries.STRUCTURE_PROCESSOR, BygoneFortressMod.MODID);
